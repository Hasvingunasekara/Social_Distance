...
labelsPath = "Files/coco.names.txt"
LABELS = open(labelsPath).read().strip().split("\n")

np.random.seed(42)

weightsPath = "Files/yolov3-tiny.weights"
configPath = "Files/yolov3-tiny.cfg.txt"
...
while True:
    ...
    if writer is None:
        ...
        writer = cv2.VideoWriter("Files/output.gif", fourcc, 30,
